                        ...
                        <Table>
                            <TableHeader>
                                <TableRow className="border-b border-border/50 hover:bg-transparent px-6 text-foreground">
                                    <TableHead className="pl-10 font-black uppercase text-[10px] tracking-widest h-16 text-foreground">Visual Artifact</TableHead>
                                    <TableHead className="font-black uppercase text-[10px] tracking-widest h-16 text-foreground">Taxonomy</TableHead>
                                    <TableHead className="font-black uppercase text-[10px] tracking-widest h-16 text-foreground">Narrative Caption</TableHead>
                                    <TableHead className="text-right pr-10 font-black uppercase text-[10px] tracking-widest h-16 text-foreground">Curation</TableHead>
                                </TableRow>
                            </TableHeader>
                            <TableBody>
                                {images.length === 0 ? (
                ...
                <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto thin-scroll rounded-[40px] border-none shadow-2xl p-0">
                    <DialogHeader className="bg-primary/5 p-6 pb-2 border-b border-primary/10">
                        <div className="flex items-center gap-4 mb-4">
                            ...
                            <div>
                                <DialogTitle className="text-3xl font-black italic tracking-tighter text-primary">Capture Blueprint</DialogTitle>
                        ...
                        <div className="p-6 space-y-6">
                            <div className="max-w-sm mx-auto bg-black/5 border border-border/50 rounded-[40px] overflow-hidden shadow-2xl group/prev relative aspect-video flex items-center justify-center">
                                <img
                                    ...
                                    className="max-h-full max-w-full object-contain transition-transform duration-700 group-hover/prev:scale-[1.05]"
                                    onError={(e) => {
                                        e.currentTarget.src = '/placeholder.svg';
                                    }}
                                />
                                <div className="absolute top-4 right-4">
                                    <Badge className="bg-white/90 backdrop-blur shadow-lg text-primary border-none rounded-full px-4 py-1.5 text-[10px] font-black uppercase tracking-widest">Hi-Res Certified</Badge>
                                </div>
                            </div>
